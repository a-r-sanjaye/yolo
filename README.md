...
✔️ Label + confidence scored bounding boxes  
✔️ Saves detected output automatically  
✔️ Lightweight, works on CPU & GPU  
✔️ Custom YOLO model support  
✔️ Designed for practical projects and demos  
